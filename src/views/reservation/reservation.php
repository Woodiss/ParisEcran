...
<div class="reservation-container">
        ...
        <div class="box reservation-card">
            ...
            <div class="details-container">
                ...
                <div class="reservation-details">
                    <h2>LEYN - The Darkness Within</h2>
                    <!-- "&nbsp;" insère un espace entre deux éléments sans permettre de retour à la ligne à cet endroit -->
                ...
                <div class="reservation-price">
                    ...
                    <div class="quantity-control">
                            ...
                            <form method="" action="">
                            <button type="submit" name="" value="" class="btn-decrease">-</button>
                            <input type="text" name="quantity" value="1" readonly>
                            <button type="submit" name="" class="btn-increase">+</button>
                        </form>
        ...
        <div class="box total-container">
            <p>Total : <span class="total-price">16 € TTC</span></p>
        </div>
