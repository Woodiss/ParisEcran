        ...
        <div class="section-cinema">
            ...
            <?php foreach ($cinemas as $cinema) { ?>
                <div class="cinema" data-id="<?= $cinema['cinema_id'] ?>" data-lat="<?= $cinema['latitude'] ?>" data-long="<?= $cinema['longitude'] ?>">
                    ...
                    <?php
                    if ($cinema['AverageRating'] != 0) {
                        for ($i = 0; $i < 5; $i++) {
                            if ($i < round($cinema['AverageRating'])) { ?>
                            ...
                            <?php  } else { ?>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_24_1243)">
                                        <path d="M7.99998 1.86667L10.1333 5.86667L15.2 6.66667L11.7333 9.86667L12.2666 14.6667L7.73332 12.5333L3.73332 14.6667L3.99998 9.86667L1.06665 6.4L5.59998 5.86667L7.99998 1.86667Z" fill="#8D8D8D" stroke="none" />
                        ...
                        <p>Ce cinema n'a pas encore reçu de note.</p>
                    <?php } ?>
